...
window.LIB = [
  ...
  ["Hack Squat","Machine","Keep your back against the pad, sit deep, and drive through mid-foot.","Legs"],
  ["Smith Machine Squat","Machine","Brace hard, keep feet planted, and control the bar path both ways.","Legs"],
  ["Smith Machine Bench Press","Machine","Set the bench so the bar tracks over mid-chest, lower controlled, press evenly.","Chest"],
  ["Shoulder Press Machine","Machine","Set handles near shoulder height, press overhead without shrugging.","Shoulders"],
  ["Assisted Pull-up Machine","Machine","Use enough assistance for full range, pull chest tall, lower slowly.","Back"],
  ["Assisted Dip Machine","Machine","Keep shoulders down, elbows track back, press through the handles.","Chest"],
  ["Cable Fly","Machine","Slight elbow bend, bring hands together at chest height, control the stretch.","Chest"],
  ["Reverse Pec Deck","Machine","Chest against pad, lead with elbows, squeeze rear delts at the back.","Shoulders"],
  ["Machine Preacher Curl","Machine","Upper arms stay on the pad, curl smoothly, avoid bouncing at the bottom.","Arms"],
  ["Tricep Extension Machine","Machine","Keep elbows lined up with the pivot, extend fully, return under control.","Arms"],
  ["Glute Kickback Machine","Machine","Brace your torso, drive heel back and up, squeeze glute without arching.","Legs"],
  ["Hip Abductor Machine","Machine","Sit tall, push knees out smoothly, pause before returning.","Legs"],
  ["Hip Adductor Machine","Machine","Control the inward squeeze, pause briefly, then return without slamming.","Legs"],
  ["Standing Calf Raise Machine","Machine","Drop into a full stretch, rise high, pause at the top.","Legs"],
  ["Ab Crunch Machine","Machine","Round ribs toward hips, move with your abs, avoid pulling with arms.","Core"],
  ["Back Extension Machine","Machine","Hinge at the hips, keep spine neutral, squeeze glutes to come up.","Back"],
